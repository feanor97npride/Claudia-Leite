...
function SectionTitle({ n, color, children }: { n: number; color: string; children: ReactNode }) {
  return (
  ...
  return (
    ...
    >
      ...
      <div className="px-6 py-3.5 space-y-3.5">
        {/* 1. Panorama */}
        <section>
          <SectionTitle n={1} color={ACCENTS[0]}>
            Panorama da semana
          </SectionTitle>
        ...
        <section>
          <SectionTitle n={2} color={ACCENTS[1]}>
            ★ Entregas da semana
          </SectionTitle>
        ...
        {/* 3. Avanços - também em destaque */}
        <section>
          <SectionTitle n={3} color={ACCENTS[2]}>
            ★ Avanços antecipados para a próxima semana
          </SectionTitle>
          <div className="rounded-xl border-2 border-sky-300 bg-gradient-to-br from-sky-50 to-white p-2.5">
            {advances.length === 0 ? (
              <p className="text-slate-400 italic text-[10px]">Nenhum avanço antecipado registrado.</p>
            ) : (
              <div className="grid grid-cols-2 gap-x-4 gap-y-1">
                {advances.map((a, i) => (
                  <div key={i} className="flex items-start gap-1.5 text-[10px] text-sky-900">
        ...
        {hasInsights && (
          <section>
            <SectionTitle n={4} color={ACCENTS[3]}>
              Insights da semana
            </SectionTitle>
        ...
        {nextSteps.length > 0 && (
          <section>
            <SectionTitle n={5} color={ACCENTS[4]}>
              Próximos passos
            </SectionTitle>
